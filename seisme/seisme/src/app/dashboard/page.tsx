    ...
    <Layout>
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Vue d'ensemble des données sismiques</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button 
              onClick={() => window.location.href = '/seisms'}
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">Voir les séismes</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">Carte des séismes</span>
            </button>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700">Analyse STL</span>
            </button>
          </div>
        </div>
            ...
            {[1, 2, 3].map((item) => (
              <div key={item} className="flex items-center p-3 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-gray-900">Mise à jour des données sismiques</div>
                  <div className="text-xs text-gray-500">Il y a {item * 2} heures</div>
                </div>
